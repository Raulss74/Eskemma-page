...
interface BasicSuscriptionModalProps {
  isOpen: boolean;
  onClose: () => void;
  onPaymentSuccess: () => void; // Nueva prop para manejar el éxito del pago
}
...
export default function BasicSuscriptionModal({
  ...
  const [selectedService, setSelectedService] = useState<string>("Moddulo"); // Estado para almacenar el servicio seleccionado
    ...
    >
      ...
      >
        ...
        <div className="space-y-6 text-left">
          ...
          {/* Espacio cuadrado para incluir una imagen */}
          <div className="flex justify-center">
            <img
              src="https://images.unsplash.com/photo-1565350552203-b68085b104df?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" // Ruta de la imagen del Plan Básico
              alt="Plan Básico"
          ...
          <div className="space-y-2">
            <label className="flex items-center space-x-2 ml-4">
              <input
                ...
                className="form-radio text-blue-eske"
              />
            ...
            <label className="flex items-center space-x-2 ml-4">
              <input
                ...
                name="service"
                value="Cursos online"
                checked={selectedService === "Formación online"}
                onChange={(e) => setSelectedService(e.target.value)}
                className="form-radio text-blue-eske"
              />
            ...
            <label className="flex items-center space-x-2 ml-4">
              <input
                ...
                className="form-radio text-blue-eske"
              />
              <span className="ml-2 not-first:text-10px font-normal text-gray-700">Monitor</span>
            </label>
          </div>
