  ...
  const teamMembers: TeamMember[] = [
    {
        ...
        image: "https://res.cloudinary.com/dngirajdx/image/upload/v1742071658/RSS_px_ma1vf8.jpg", // Enlace directo
      ...
      },
    {
      ...
      image: "https://i.pravatar.cc/150?img=38", // Reemplaza con la ruta real de la imagen
    ...
    },
    {
      ...
      role: "Administradora",
      bio: "Contadora de profesión y administradora por vocación, Yolanda combina su experiencia y cretividad para hacer posibles los procedimientos que facilitan los proyectos de los clientes de Eskemma.",
      image: "https://i.pravatar.cc/150?img=10", // Reemplaza con la ruta real de la imagen
      contact: "yolandaorozcol@eskemma.com"
    },
    {
      id: 4,
      name: "David Quezada Mendoza",
      role: "Consultor poítico",
      ...
      image: "https://i.pravatar.cc/150?img=52", // Reemplaza con la ruta real de la imagen
      ...
      {isOpen && (
        ...
        style={{ backgroundColor: "rgba(0,0,0, 0.6)" }}> 
          ...
          <div className="bg-white-eske rounded-lg shadow-lg w-full max-w-md p-6 relative overflow-hidden">
            ...
            {/* Encabezado */}
            <h3 className="text-16px font-medium text-blue-eske mb-1 text-center">{currentMember.name}</h3>
            <p className="text-12px text-gray-700 mb-8 text-center">{currentMember.role}</p>
